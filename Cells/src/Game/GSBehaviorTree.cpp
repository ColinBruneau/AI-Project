...
void GSBehaviorTree::deleteEntities()
{
...
void GSBehaviorTree::createEntities()
{
...
void GSBehaviorTree::setBehavior()
{
	for (int i = 0; i < m_iNbEntities; i++)
	{
		std::string s = std::to_string(i);
...
bool GSBehaviorTree::onDraw()
{
	return true;
}

bool GSBehaviorTree::onQuit()
{	
	m_pGM->clearAllData();
